...
task_arr.append(Task("rpm --import https://www.elrepo.org/RPM-GPG-KEY-elrepo.org"))
task_arr.append(Task("rpm -Uvh http://www.elrepo.org/elrepo-release-7.0-2.el7.elrepo.noarch.rpm"))
task_arr.append(Task("yum --enablerepo=elrepo-kernel install kernel-ml -y"))
task_arr.append(Task("rpm -qa | grep kernel"))
task_arr.append(Task("egrep ^menuentry /etc/grub2.cfg | cut -f 2 -d \'"))
task_arr.append(Task("grub2-set-default 1"))
